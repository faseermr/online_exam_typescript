...
export const getAllClassAction = () => async (dispatch: Dispatch) => {
  try {
...
export const addClassAction =
  (classroom: any) => async (dispatch: Dispatch) => {
    try {
...
export const updateClassAction =
  (id: any, classroom: any) => async (dispatch: Dispatch) => {
    try {
...
export const deleteClassAction = (id: any) => async (dispatch: Dispatch) => {
  try {
