          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              >
                ...
                {subjectList.map((val: any, idx) => {
                  return (
                    <option
                      key={idx}
                      value={val.subid}
                      selected={val.subid == subject}
                    >
                      {val.grade} {val.name}
                    </option>
                  );
            ...
            <div className="form-group mt-2">
              ...
              >
                ...
                <option
                  selected={values.answer1 == correct_answer}
                  value={values.answer1}
                >
                  Answer 1
                </option>
                <option
                  selected={values.answer2 == correct_answer}
                  value={values.answer2}
                >
                  Answer 2
                </option>
                <option
                  selected={values.answer3 == correct_answer}
                  value={values.answer3}
                >
                  Answer 3
                </option>
                <option
                  selected={values.answer4 == correct_answer}
